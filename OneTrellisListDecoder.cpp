...
std::vector<std::vector<ListDecoder::cell>> ListDecoder::constructOneTrellis(std::vector<double> receivedMessage){
...
ListDecoder::messageInformation ListDecoder::oneTrellisDecoding(std::vector<double> receivedMessage){
