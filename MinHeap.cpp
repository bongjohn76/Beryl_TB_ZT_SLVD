...
void minheap::reHeap(int index){
    ...
    if(leftIndex < detourList.size() && detourList[leftIndex] < detourList[minDetourIndex])
        minDetourIndex = leftIndex;
    if(rightIndex < detourList.size() && detourList[rightIndex] < detourList[minDetourIndex])
