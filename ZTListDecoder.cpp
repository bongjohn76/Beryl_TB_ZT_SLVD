...
std::vector<std::vector<ListDecoder::cell>> ListDecoder::constructZTTrellis(std::vector<double> receivedMessage){
...
ListDecoder::messageInformation ListDecoder::ztListDecoding(std::vector<double> receivedMessage){
